...
from dtPyLibs.elastic.elastic import Elastic
...
class APICache:
    configuration_file = './config/cacheConfig.yaml'

    def __init__(self, cache_name, max_age=86400000):
    ...
    def __configure_elastic_cache(self):
        self.elastic_connection = Elastic(api_key=self.config['elastic']['api_key'],
