...
from digital_thought.commons.converters import json as json_converters
from dtPyLibs.enrichers import ipAddressDomainDetails
...
class AuditReport:
    ...
    def enrich_ip_addresses(self, api_keys):
        enricher = ipAddressDomainDetails.IPAddressDomainInfo(api_keys=api_keys)
